...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    // Імітація запиту API для отримання даних
    setStats({
      totalExhibits: 150,
      totalCategories: 10,
      totalNews: 50,
  ...
  return (
    <div className="p-6 text-black">
      ...
      <div className="grid text-black grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <StatCard icon={Package} title="Всього експонатів" value={stats.totalExhibits} />
        <StatCard icon={Layers} title="Всього категорій" value={stats.totalCategories} />
        <StatCard icon={FileText} title="Всього новин" value={stats.totalNews} />
        <StatCard icon={Users} title="Всього відвідувачів" value={stats.totalVisitors} />
      </div>
