...
const news = [
	{
		...
		content: "Музей відкриває нову виставку сучасного мистецтва...",
		date: "2024-10-15",
		relatedExhibitions: []
	},
	{
...
const exponat = {
	...
	description: "Картина, яка зображує вечірній пейзаж з ландшафтами Італії. Створена в стилі бароко.",
	origin: "Італія",
